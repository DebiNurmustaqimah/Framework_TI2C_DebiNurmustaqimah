...
<head>
    ...
    <style>
        ...
        .login-card button:hover {
            background-color:#F2BED1(0, 0, 0, 0.85);
            cursor: pointer;
        }
    ...
    <div class="login-card-container">
        <div class="login-card">
            <div class="login-card-logo">
                <h2>WELCOME TO WEBSITE PORTOFOLIO</h2>
                <div>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum at ab consequatur repellat! Commodi iste nisi rem numquam quae hic.</div>
            </div>
            ...
            <form class="login-card-form">
                <div class="form-item">
                    ...
                    <input type="text" placeholder="Enter Username" id="UsernameForm" autofocus required>
                </div>
                <div class="form-item">
                ...
                <div class="form-item">
                    <span class="form-item-icon material-symbols-rounded">lock</span>
                    <input type="password" placeholder="Enter Password Again" id="passwordAgainForm" required>
                </div>
